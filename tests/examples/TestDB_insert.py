...
class TestDBAlchemy(unittest.TestCase):
    ...
    def test_call_dbinsert_and_check_fukazawa(self):
        """dbinsert.phpにアクセスした後、DBのpersonテーブルを確認し、'深沢七郎'がnameに含まれるレコードがあるかを確認する"""
        self.driver.get("http://web/dbinsert.php")
        self.driver.get_screenshot_as_file("results/02-dbinsert.png")
